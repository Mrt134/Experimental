# -*- coding: utf-8 -*-
#
# rst2pdf testing documentation build configuration file, created by
# sphinx-quickstart on Wed Aug 24 09:22:17 2016.
#
...
project = u'rst2pdf testing'
copyright = u'2016, Tim Moore'
author = u'Tim Moore'
...
#
# html_title = u'rst2pdf testing v0.1'
...
htmlhelp_basename = 'rst2pdftestingdoc'
...
latex_documents = [
    (master_doc, 'rst2pdftesting.tex', u'rst2pdf testing Documentation',
     u'Tim Moore', 'manual'),
]
...
man_pages = [
    (master_doc, 'rst2pdftesting', u'rst2pdf testing Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'rst2pdftesting', u'rst2pdf testing Documentation',
     author, 'rst2pdftesting', 'One line description of project.',
     'Miscellaneous'),
]
